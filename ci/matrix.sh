...
export BUILDER_IMAGE_NAME="helpthehomeless-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export USE_SHELL="/bin/helpthehomeless"
  export PYZMQ=true
  export RUN_TESTS=true
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_helpthehomeless_DEBUG"
  export PYZMQ=true
  export RUN_TESTS=true
