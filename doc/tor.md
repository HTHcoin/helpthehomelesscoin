...
It is possible to run HelpTheHomeless as a Tor hidden service, and connect to such services.
...
1. Run HelpTheHomeless behind a Tor proxy
----------------------------------

The first step is running HelpTheHomeless behind a Tor proxy. This will already make all
...
2. Run a HelpTheHomeless hidden server
-------------------------------
...
your dashd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell HelpTheHomeless about its publicly reachable address using
...
3. List of known HelpTheHomeless Tor relays
------------------------------------
...
HelpTheHomeless has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
HelpTheHomeless automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if HelpTheHomeless is listening (`-listen`), and
