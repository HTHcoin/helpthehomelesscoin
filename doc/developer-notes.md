...
HelpTheHomeless is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as HelpTheHomeless, where everyone uses
...
pay attention to for reviewers of HelpTheHomeless code.

General HelpTheHomeless
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: HelpTheHomeless uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against HelpTheHomeless so that they can be integrated
