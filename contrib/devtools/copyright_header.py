...
Arguments:
    <base_directory> - The base directory of a HelpTheHomeless source code repository.
...
Arguments:
    <base_directory> - The base directory of HelpTheHomeless source code repository.
"""
...
Arguments:
    <file> - A source file in the HelpTheHomeless repository.
"""
