...
$(package)_download_path=https://download.qt.io/official_releases/qt/5.15/5.15.0/$($(package)_version)/submodules
$(package)_suffix=qtbase-everywhere-src-$($(package)_version).tar.gz
