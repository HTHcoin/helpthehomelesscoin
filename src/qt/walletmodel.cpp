    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // PaymentRequest...
            ...
            for (int i = 0; i < details.outputs_size(); i++)
            {
                ...
                CRecipient recipient = {scriptPubKey, nAmount, rcp.imgbase64.toStdString() , rcp.fSubtractFeeFromAmount};
        ...
        {   // User-entered dash address / amount:
            ...
            CRecipient recipient = {scriptPubKey, rcp.amount, rcp.imgbase64.toStdString(), rcp.fSubtractFeeFromAmount};
            vecSend.push_back(recipient);
