...
public:
    ...
    TransactionRecord(uint256 _hash, qint64 _time):
            hash(_hash), time(_time), type(Other), address(""), imgbase64(""), debit(0),
            credit(0), idx(0)
    {
    }
    ...
    TransactionRecord(uint256 _hash, qint64 _time,
            ...
            hash(_hash), time(_time), type(_type), address(_address), imgbase64(imgbase64), debit(_debit), credit(_credit),
            idx(0)
    {
    }
