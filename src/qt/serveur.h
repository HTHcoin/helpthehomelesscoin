...
class IrcServer : public QTcpSocket
{
	...
	public:
        IrcServer();
        QTextEdit *editor;
        QString pseudo,serverName,msgQuit;
		int port;
        ChatTabHolder *tab;
	...
	public Q_SLOTS:
        ...
        void writeToTab(QString txt,QString destChan="",QString msgTray="");
        void updateUsersList(QString chan="",QString message="");
        QString nickFromTarget(const QString& target);
        QString hostFromTarget(const QString& target);
        void HandleUserJoin(QString nick, QString channel);
        void HandleUserPart(QString nick, QString channel);
